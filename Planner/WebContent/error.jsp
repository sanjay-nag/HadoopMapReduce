...
<body>
	...
	<div class="row">
		...
		<a href="index.jsp"><img src="images/logo.png" alt="desc"
			...
			<div class="row">
				...
				<div class="heading_dots hide-for-small">
					<h1 class="heading_supersize">
						<span class="heading_center_bg">This is Annoying</span>
					</h1>
				</div>
				...
				<div class="twelve columns">
					...
					<p class="welcome_text">Sorry !! Something went wrong. Please
						try again later</p>
